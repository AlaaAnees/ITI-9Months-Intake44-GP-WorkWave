  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      shortTitle: Yup.string()
        ...
        .max(15, "Title Short must be less than  15 char"),
      cover: Yup.string().required(),
      images: Yup.string().required(),
      shortDesc: Yup.string()
        .required()
        .min(4, "Short description must be at least 4 char")
        .max(15, "Short description must be less than  15 char"),
      desc: Yup.string()
        .required()
        .min(4, "Short description must be at least 4 char")
        .max(40, "Short description must be less than  15 char"),
        ...
        <div className="collll">
          ...
          <div>
            ...
            {formik.touched.cover && formik.errors.cover ? (
              <div className="text-red-600 text-sm">{formik.errors.cover}</div>
            ) : null}
          </div>
          <div>
            ...
            {formik.touched.images && formik.errors.images ? (
              <div className="text-red-600 text-sm">{formik.errors.images}</div>
            ) : null}
          </div>
          <div>
